...
const ManageTutor = async (props: Props) => {
    ...
    return (
        <main className="p-8  md:pt-8 xl:p-5 mx-auto max-w-7xl lg:max-w-8xl mt-3">
            <div className="flex items-center mb-5">
                <div className=" flex flex-col gap-1">
                    ...
                    <h1 className="text-zinc-500 text-[15px] w-10/12 dark:text-zinc-300 mb-5 ">
                        Below are the tutors you've made or have access to.
                        Click on one to manage or share that specific tutor!
                    </h1>
