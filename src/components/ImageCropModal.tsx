...
export const ImageCropModal = ({ open, setOpen, selectedImage, setSelectedImage, setCroppedImage }: Props) => {
      ...
      <DrawerContent>
        <div className="relative p-4 w-full max-w-screen h-[90vh] flex flex-col items-center">
          <DrawerHeader className="flex flex-col justify-center items-center">
            ...
            <DrawerDescription>Select the question you would like to solve together.</DrawerDescription>
          </DrawerHeader>
          ...
          <DrawerFooter className="fixed bottom-4">
            ...
            <DrawerClose asChild>
              <Button variant="outline" onClick={handleAbort}>Cancel</Button>
            </DrawerClose>
          </DrawerFooter>
        </div>
      </DrawerContent>
