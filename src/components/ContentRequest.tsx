                    ...
                    <Card className="w-[30rem]">
                        <CardHeader>
                            ...
                            <CardDescription className="text-[16px] ">
                                Hello! I'll be uploading the content you
                                provided to Pear's database as soon as I can.
                                You should be able to create a "Custom Content"
                                or "Textbook" check-in based on this content
            ...
            <div className="absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                <Card className="max-w-[38rem]">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Request for the content you want to base your
                            check-ins off of. Could be name of the textbook you
                            use or links material like slides, docs, or websites
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Form {...form}>
