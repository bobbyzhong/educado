      ...
      <div className='w-full'>
          <div className="flex items-center mb-5 pl-2">
              <div className=" flex flex-col items-center w-full gap-1">
                  ...
                  <a className='font-bold'>Total Number of Questions Asked By Students: {numberOfQuestions}</a>
                  <h1 className="text-zinc-500 text-[15px] dark:text-zinc-300 text-center">
                      Here are some of the recently asked questions in your district. 
                      View an expanded history{" "}
                      <Link
