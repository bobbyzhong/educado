      ...
      <div className="absolute -translate-x-1/2 -translate-y-1/2 flex items-center justify-center flex-col top-1/2 left-1/2">
        <Card className="mt-8 mb-5 w-full max-w-[30rem]">
          <CardHeader>
            ...
            <CardDescription>
              You can upload your own content by going to the dashboard and
              clicking the "Content Request" card. You can also just create a
              check-in based on a topic or school standard by going{" "}
              <Link
        ...
        <div className="absolute -translate-x-1/2 flex items-center justify-center flex-col left-1/2">
          <Card className="mt-8 mb-5 w-full max-w-[30rem]">
            <CardHeader>
              ...
              <CardDescription>
                Enter the name of the content you've uploaded that you want to
                create a check-in on. Make sure to enter the name of the content
                exactly as it appears on the left.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                ...
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          This is for your reference only. Anything put in here
                          will not be used to create the check-in.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Content Name(s)</FormLabel>
                        <FormControl>
                          <Textarea
                        ...
                        <FormDescription>
                          Enter the name of the content exactly as it appears on
                          the left
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Topics to Emphasize (Optional)</FormLabel>
                        <FormControl>
                          <Textarea
                        ...
                        <FormDescription>
                          Enter subtopics from your content you want to
                          emphasize
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Curriculum/Standards</FormLabel>
                        <Select
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="NGSS CA Grades 9-12 Life Science">
                              NGSS CA Grades 9-12 Life Science
                            </SelectItem>
                            <SelectItem value="NGSS CA Grades 9-12 Physical Science">
                              NGSS CA Grades 9-12 Physical Science
                            </SelectItem>
                          </SelectContent>
                        </Select>
                        <FormDescription>
                          Send a request for a curriculum or standard if you
                          want yours listed
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
          ...
          {apiError && (
            <div className="w-full flex flex-col items-center mb-5 justify-center ">
              ...
              <p className="text-sm text-zinc-500 text-center w-9/12">
                Really sorry there was an error with the check-in! Due to the
                high amount of traffic we're receiving, you might need to
                refresh your page or try again. If it still doesn't work, we're
                really sorry, the team at Pear is working to fix any bugs.
              </p>
            </div>
          )}
          {showLoader && (
