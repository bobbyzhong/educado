...
const examples = [
  "Give me a list of facts about temperature",
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Make sure you put your full name and have no typos
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <div className="mt-0 md:mt-10 mx-3 font-outfit flex flex-col items-center justify-center">
              ...
              <div className="flex w-full items-center justify-center flex-col">
                <h1 className="text-4xl font-semibold text-center">
                  Hey, I’m{" "}
                  <span className="text-green">{tutorDisplayName}!</span>
                </h1>
                <p className="text-lg text-center font-light mt-5 w-full">
                  I’m your tutor for {ownerName}’s class. You can ask me for
                  help with anything related to her class. Whether you didn’t
                  really understand a certain topic or want to study together
                  before you next test, I’m here to help!
                </p>
              </div>
        ...
        >
          <div className="relative flex flex-col h-full flex-1 items-stretch md:flex-col">
            ...
            >
              <Link
                href={"/pastConvos"}
                className="text-center mr-2 bg-green text-white rounded-md px-3 py-1 cursor-pointer text-[15px] font-semibold"
              >
                <p>View History</p>
              </Link>
              <Textarea
              ...
              />
              {isLoading ? (
                <Loader2 color="#86D20A" className="animate-spin" size={26} />
              ) : (
                <SendHorizonal
                  className="cursor-pointer"
                  onClick={onHandleSubmit}
                  color={input.length === 0 ? "#D3D3D3" : "#86D20A"}
                  size={26}
                />
              )}
            </div>
