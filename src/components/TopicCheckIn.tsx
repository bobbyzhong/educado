  ...
  return (
    <div className="absolute -translate-x-1/2 flex items-center justify-center flex-col left-1/2">
      <Card className="mt-16 mb-5 w-full max-w-[38rem]">
        <CardHeader>
          <CardTitle className="font-bold text-2xl">New Check-In</CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      This is for your reference only. Anything put in here will
                      not be used to create the check-in.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Please provide a topic or concept to base the check-in on.
                      Make sure to put specific topics or concepts if you want
                      the check-in to be focused on a specific topic.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Send a request for a curriculum or standard if you want
                      yours listed
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Put any context you want your check-in to have. The
                      content put here will be the content that the check-in is
                      based on.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
      ...
      {apiError && (
        <div className="w-full flex flex-col items-center mb-5 justify-center ">
          ...
          <p className="text-sm text-zinc-500 text-center w-9/12">
            Please refresh your page and try again. If this problem persists,
            please contact us.
          </p>
        </div>
      )}
